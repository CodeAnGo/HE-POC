        ...
        <div class="kt-widget kt-widget--user-profile-1">
            ...
            <div class="kt-widget__body">
                <div class="kt-widget__content">
                    ...
                    @if(isset(Auth::user()->getProfile->phone_number) && !empty(Auth::user()->getProfile->phone_number))
                        <div class="kt-widget__info">
                            <span class="kt-widget__label">Phone:</span>
                            <a href="#" class="kt-widget__data">{{ Auth::user()->getProfile->phone_number }}</a>
                        </div>
                    @endif
                    @if(isset(Auth::user()->getProfile->country) && !empty(Auth::user()->getProfile->country))
                        <div class="kt-widget__info">
                            <span class="kt-widget__label">Location:</span>
                            <span class="kt-widget__data">{{ Auth::user()->getProfile->country }}</span>
                        </div>
                    @endif
                </div>
                <div class="kt-widget__items">
                    <a href="{{ route('overview.index') }}" class="kt-widget__item @if (\Route::current()->getName() == 'overview.index') kt-widget__item--active @endif">
                    ...
                    <a href="{{ route('personal-information.index') }}" class="kt-widget__item  @if (\Route::current()->getName() == 'personal-information.index') kt-widget__item--active @endif">
                                        <span class="kt-widget__section">
                                            <span class="kt-widget__icon">
                                                <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1" class="kt-svg-icon">
                                                    <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                    ...
                    <a href="{{ route('account-information.index') }}" class="kt-widget__item @if (\Route::current()->getName() == 'account-information.index') kt-widget__item--active @endif">
                                        <span class="kt-widget__section">
                                            <span class="kt-widget__icon">
                                                <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1" class="kt-svg-icon">
                                                    <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                    ...
                    <a href="{{ route('password.index') }}" class="kt-widget__item @if (\Route::current()->getName() == 'password.index') kt-widget__item--active @endif">
                                        <span class="kt-widget__section">
                                            <span class="kt-widget__icon">
                                                <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1" class="kt-svg-icon">
                                                    <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                    ...
                    <a href="{{ route('email.index') }}" class="kt-widget__item @if (\Route::current()->getName() == 'email.index') kt-widget__item--active @endif">
                                        <span class="kt-widget__section">
                                            <span class="kt-widget__icon">
                                                <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1" class="kt-svg-icon">
                                                    <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                    ...
                    <a href="{{ route('integrations.index') }}" class="kt-widget__item @if (\Route::current()->getName() == 'integrations.index') kt-widget__item--active @endif"" data-toggle="kt-tooltip" data-placement="right">
                                        <span class="kt-widget__section">
                                            <span class="kt-widget__icon">
                                                <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1" class="kt-svg-icon">
                                                    <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                            ...
                                            <span href="#" class="kt-widget__desc">Integration Management</span>
                                        </span>
                    </a>
                    <a href="#" class="kt-widget__item" data-toggle="kt-tooltip" title="Coming soon..." data-placement="right">
                                        <span class="kt-widget__section">
