...
@push('css')
    <link rel="stylesheet" href="{{ asset('css/demo1/pages/wizard/wizard-1.css') }}">
@endpush

@push('js')
    <script href="{{ asset('js/demo1/pages/custom/projects/add-project.js') }}"></script>
@endpush
            ...
            <div class="kt-portlet__body kt-portlet__body--fit">
                <div class="kt-grid  kt-wizard-v1 kt-wizard-v1--white" id="kt_apps_projects_add" data-ktwizard-state="step-first">
                    ...
                    <div class="kt-grid__item kt-grid__item--fluid kt-wizard-v1__wrapper">
                        ...
                        <form class="kt-form" id="kt_apps_projects_add_form">
                                        ...
                                        <div class="row">
                                            <div class="col-xl-12">
                                                <div class="kt-section__body">
                                                    ...
                                                    <div class="form-group row">
                                                        <label class="col-xl-3 col-lg-3 col-form-label">Project Tagline</label>
                                                        <div class="col-lg-9 col-xl-9">
                                                            <input class="form-control" type="text" value="Loop Inc.">
                                                        </div>
                                                    </div>
                                                    <div class="form-group row">
                                                        <label class="col-xl-3 col-lg-3 col-form-label">Project Description</label>
                                                        <div class="col-lg-9 col-xl-9">
                                                            <div class="input-group">
                                                                <textarea name="description" id="projectDescription" class="form-control" cols="30" rows="3" placeholder="Description"></textarea>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="form-group row">
                                                        <label class="col-xl-3 col-lg-3 col-form-label">Cloud Provider</label>
                                                        <div class="col-lg-9 col-xl-9">
                                                            <div class="input-group">
                                                                <select disabled  class="form-control" name="cloud" id="projectProvider">
                                                                    <option selected value="AWS">Amazon Web Services</option>
                                                                    <option value="GCP">Google Cloud Platform</option>
                                                                    <option value="Azure">Microsoft Azure</option>
                                                                    <option value="Hybrid">Hybridized Cloud</option>
                                                                </select>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="form-group form-group-last row">
                                                        <label class="col-xl-3 col-lg-3 col-form-label">Project Logo</label>
                                                        <div class="col-lg-9 col-xl-9">
                                                            <div class="input-group">
