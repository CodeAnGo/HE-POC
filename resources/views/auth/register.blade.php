...
<head>
    <meta charset="utf-8" />
    <title>CloudBurst | Register</title>
                    ...
                    <div class="kt-login__form">
                        ...
                        <form class="kt-form" action="/register" method="POST">
                            ...
                            <div class="kt-login__actions">
                                <a href=""></a>
                                <button type="submit" class="btn btn-primary btn-elevate kt-login__btn-primary">Register</button>
                            </div>
                        ...
                        <div class="kt-login__options">
                            <a href="/login" class="btn btn-danger kt-btn">
                                <i class="fa fa-user"></i>
                                Login
                            </a>
                            <br>
                            <a href="/register/magic" class="btn btn-info kt-btn">
